    ...
    <div className="min-h-screen bg-page-canvas flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 bg-page-canvas">
          {/* White Content Container - Only for title and tabs */}
          ...
          <div className="bg-page-canvas min-h-screen">
            <div className="p-8">
              ...
              {activeTab === 'Users' && (
                <div>
                  {/* "All users" section with search/filters and table - Single White Container */}
                  <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center gap-3">
                          <div className="relative">
                            <button className="flex items-center gap-2 px-3 h-8 text-sm border border-gray-300 rounded-[16px] hover:bg-gray-50">
                              More actions
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div className="relative">
                            <button className="flex items-center gap-2 px-4 h-8 bg-linkedin-blue text-white text-sm font-medium rounded-[16px] hover:bg-linkedin-blue-dark">
                              Add new users
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                              </svg>
                    ...
                    {/* Data Table - Connected directly below */}
                        ...
                        {users.map((user) => (
                          <tr key={user.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                              <button className="text-dismiss-icon hover:text-dismiss-icon-hover">
